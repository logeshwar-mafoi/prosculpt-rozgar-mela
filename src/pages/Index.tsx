...
const tourismCompanies = [
  ...
  { name: "Ziatoon Restaurant and Grill Pvt. Ltd.", logo: "/assets/health-and-tour/zaitoon.png", description: "Tourism and hospitality", jobOpenings: 25, location: "Pan India", jobId: "zaitoon-11223" },
];
