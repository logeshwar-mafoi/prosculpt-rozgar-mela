...
const tourismCompanies = [
  ...
  { name: "ConnectED (Kukje India Group Initiative)", logo: "/assets/health-and-tour/kukjeoverseas.jpg", description: "Tourism and hospitality", jobOpenings: 150, location: "Korea", jobId: "zai-11223" },
