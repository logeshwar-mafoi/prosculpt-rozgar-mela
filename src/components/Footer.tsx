      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mb-6 md:mb-8">
          ...
          <div className="flex flex-col items-center md:items-end justify-center text-center md:text-right">
            ...
            <p className="text-xs text-white/60 mt-4 md:mt-6">
        ...
        {/* CTA Section */}
        <div className="flex flex-col sm:flex-row flex-wrap gap-3 md:gap-4 justify-center mb-8 md:mb-12">
        ...
        <div className="border-t border-white/10 pt-6 md:pt-8 text-center text-xs md:text-sm text-white/60">
          <p>&copy; {new Date().getFullYear()} ProSculpt.co. All rights reserved.</p>
